...
export default function Casos() {
  return (
    <div className='my-18 text-gray-300'>
      <section>
        ...
        <header className='max-w-screen-lg mx-auto font-medium'>
          ...
          <h1 className='text-3xl text-center'> No busques más, porque en <span className='italic font-bold text-white text-white'>Innova Fotografía y Publicidad</span> hemos construido una sólida reputación basada en la satisfacción de nuestros clientes.
          </h1>
